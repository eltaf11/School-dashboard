            ...
            <div class="left-sidebar">
                <ul class="nav flex-column sidebar-nav">
                    ...
                    <li class="nav-item">
                        ...
                        <ul><a href="/dashboard/students/add" style="text-decoration: none !important; color: #333; ">Add Student</a></ul>
                        <ul><a href="/dashboard/students/list" style="text-decoration: none !important; color: #333; ">List Students</a></ul>
                    </li>
                    <li class="nav-item">
